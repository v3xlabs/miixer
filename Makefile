...
build:
	...
	kicad-cli pcb render --perspective --quality user -w 1800 -h 1800 --zoom 0.8 --side top -o $(OUT)/pcb-front.png $(BOARD)
	...
	kicad-cli pcb export step --no-unspecified -o $(OUT)/pcb.step $(BOARD)
